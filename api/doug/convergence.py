...
# settle.py's four weight-0 notices, appended to the later verdict's
# reasons when it disproved a finding rather than the author fixing it
# (settlement_notice, schema_settlement_notice, ci_settlement_notice,
# syntax_settlement_notice). Their label grammar is parsed below and pinned
# by tests/test_convergence.py against the real emitters. Kept as a local
