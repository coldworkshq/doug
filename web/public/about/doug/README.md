...
five filenames directly from this folder. Drop the real files in with these
...
| `pasture-lookout.jpg` | Doug and a friend looking out over a pasture   |
| `rock-hike.jpg`       | Doug and Andrew sitting on rocks after a hike  |
| `nose-boop.jpg`       | Extreme close-up of Doug's nose                |

Until all five exist, the gallery renders broken-image icons in their place
